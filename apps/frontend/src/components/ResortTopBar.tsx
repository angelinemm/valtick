...
export function ResortTopBar({ resort, summary, onReset }: Props) {
  ...
  return (
    <header style={{ display: "flex", gap: "1.5rem", padding: "0.75rem 1rem", flexWrap: "wrap", alignItems: "center" }}>
      ...
      <button
        onClick={handleReset}
        style={{ marginLeft: "auto", backgroundColor: "#cc0000", color: "white", border: "none", padding: "0.4rem 1rem", fontWeight: "bold", cursor: "pointer", borderRadius: "4px" }}
      >
        Reset
      </button>
    </header>
